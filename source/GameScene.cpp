...
void GameScene::reset() {
     ...
     if (_fight == 1){
          ...
          _enemyIdle->dispose();
          _enemyIdle->initWithFilmstrip(_assets->get<Texture>("slimeIdle"), 4, 5, 19);
          _enemyIdle->setScale(0.69f);
          _enemyIdle->setFrame(0);
          _idleBuffer = 0;
          _enemyIdle->setPosition(_dimen.width * 0.2f, _dimen.height*0.44f);
