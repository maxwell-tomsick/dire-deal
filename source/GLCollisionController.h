 ...
 */
void checkForCollision(const std::shared_ptr<Ship>& ship1, const std::shared_ptr<Ship>& ship2, const cugl::Rect bounds);
 ...
 */
void checkForCollision(const std::shared_ptr<Ship>& ship, const std::shared_ptr<PhotonQueue>& photons, const cugl::Rect bounds);
